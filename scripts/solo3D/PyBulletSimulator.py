...
class pybullet_simulator:
    ...
    def __init__(self, q_init, envID, use_flat_plane, enable_pyb_GUI, dt=0.001):
        ...
        #robotStartPos = [-0.5, 1.2, 0.0]
        robotStartPos = [0.,0., 0.0]
        robotStartOrientation = pyb.getQuaternionFromEuler([0.0, 0.0, 0.])  # -np.pi/2
        ...
        pyb.resetBasePositionAndOrientation(self.robotId, [0.,0., -z_min], robotStartOrientation)
        ...
        pyb.resetDebugVisualizerCamera(cameraDistance=3., cameraYaw=135, cameraPitch=-25,
    ...
    def check_pyb_env(self, k, envID, velID, qmes12):
        ...
        #                               cameraTargetPosition=[qmes12[0, 0], qmes12[1, 0] + 0.0, 0.0])
        pyb.resetDebugVisualizerCamera(cameraDistance=1., cameraYaw=(0.0*RPY[2]*(180/3.1415)+135), cameraPitch=-39.9,
                                      cameraTargetPosition=[qmes12[0, 0], qmes12[1, 0] + 0.0, 0.0])
