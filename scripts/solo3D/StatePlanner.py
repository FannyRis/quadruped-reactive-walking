    ...
    def computeReferenceStates(self, q,  v, v_ref):
        ...
        for i in range(1, self.n_steps + 1):
            ...
            if v_ref[5] < 10e-3:
                ...
                self.referenceStates[0, i] = (v_ref[0] * np.sin(v_ref[5] * dt) + v_ref[1] * (np.cos(v_ref[5] * dt) - 1.)) / v_ref[5]
                self.referenceStates[1, i] = (v_ref[1] * np.sin(v_ref[5] * dt) - v_ref[0] * (np.cos(v_ref[5] * dt) - 1.)) / v_ref[5]
