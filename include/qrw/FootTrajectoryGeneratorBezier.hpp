...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////////////////////////////////////////
    void update(int k, MatrixN const& targetFootstep, SurfaceVector const& surfacesSelected, MatrixN const& currentPosition);

    void updatePolyCoeff_XY(int const& i_foot, Vector3 const& x_init, Vector3 const& v_init, Vector3 const& a_init, Vector3 const& x_target, double const& t0, double const& t1);
    void updatePolyCoeff_Z(int const& i_foot, Vector3 const& x_init, Vector3 const& x_target, double const& t1, double const& h);
